 ...
 TextEditingController controller1 = TextEditingController();
  ...
  void encrypting(){
    setState(() async {
      ...
      final encrypted = await cryptor.encrypt(controller.text, text);
      print(controller.text);
      controller1.text = encrypted;
    });
  }
          ...
          children: [
            ...
            child: Column(children: [ // where to position the child
             Container(
              ...
              child: Container(
                margin: const EdgeInsets.only(top: 5),
               child: Text("Encrypt Passowrd/Text",style: TextStyle(color: Colors.white,fontSize: 20,fontFamily: 'Pix8'),textAlign: TextAlign.center,),
              ),
            ),
            Container(margin: const EdgeInsets.only(top: 50),),
            Row(
            ...
            Container(
              ...
              child: Container(
                margin: const EdgeInsets.only(top: 5),
                child: Text("Encrypt",style: TextStyle(fontSize: 20),textAlign: TextAlign.center,),
              ),
                ),
                ),
                ],),
